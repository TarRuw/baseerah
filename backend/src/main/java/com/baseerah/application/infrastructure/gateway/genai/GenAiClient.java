 ...
 * (Step 7.2), wired through the same switch in {@link com.baseerah.config.GenAiConfig}.
 *
...
public interface GenAiClient {
     ...
     * object (no entities, no Spring). Built by {@link com.baseerah.application.genai.ChatService} from the client's latest stress score and
