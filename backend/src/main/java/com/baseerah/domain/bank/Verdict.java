 ...
 * </ul>
 *
 * <p>Pure domain vocabulary — the {@link UnderwritingRule} emits it and the persistence layer stores it as
 * text in {@code loan_applications.verdict}, constrained by the migration's
