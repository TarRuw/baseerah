 ...
 *
 * <p>The option is bound as a <em>string</em>, not the {@code RescueOptionType} enum, deliberately: an
 ...
 * classify as validation. The controller resolves the validated string to {@code RescueOptionType} safely.
 *
