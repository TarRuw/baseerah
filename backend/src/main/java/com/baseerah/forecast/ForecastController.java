...
/**
 * Cash-flow forecast endpoint (FR-04, DESIGN.md §6). Thin: delegates to {@link ForecastService} and wraps
 ...
 * shared 404 error envelope (matching the other client-scoped controllers).
 *
...
public class ForecastController {
    ...
    public ApiResponse<ForecastResponse> forecast(
        ...
        return ApiResponse.ok(forecastService.forecastFor(id, horizonDays));
    }
}
